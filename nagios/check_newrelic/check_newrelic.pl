...
$getopt_result = getopts('hvdxH:t:a:A:k:', \%optarg) ;

sub HELP_MESSAGE() {
	print <<EOF;
Usage:
	$0 [-v] [-x] [-H hostname] -k API_key [-t time_out] [-a app_regex,...] [-A app_regex,...]
	...
	-x  ... don't verify the ssl certificate against the hostname (insecure)
